...
import { modelsImportProgress } from 'renderer/redux/models-loader';
import { imagesImportProgress } from 'renderer/redux/images-loader';
...
export default function StatusBar({
  ...
  const modelsLoading = useSelector(
  ...
  return (
    ...
    >
      <div className="self-end mr-4 flex flex-row">
        {(modelsLoading || lorasLoading) && (
          <div className="h-full flex items-center mr-4">
            <span className="mr-2">
              Loading models: {modelsImportProgress.value.message}{' '}
              {modelsImportProgress.value.progress}%
            </span>
            <progress
        ...
        {imagesLoading && (
          <div className="h-full flex items-center mr-4">
            <span className="mr-2">
              ...
              {imagesImportProgress.value.progress}%
            </span>
            <progress
              className="progress progress-primary w-56"
              value={0}
